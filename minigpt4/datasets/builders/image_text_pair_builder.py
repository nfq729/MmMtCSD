...
@registry.register_builder("stance_detection_conversation")
class stanceDetectionBuilder(BaseDatasetBuilder):
    train_dataset_cls = stanceDetectionDataset
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/MMCSD/conversation.yaml",
    }
